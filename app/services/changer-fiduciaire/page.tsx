...
import { CheckCircle2, MessageSquare, Clock, ShieldCheck, ArrowRight, HelpCircle } from "lucide-react";
import { Metadata } from "next";

export const metadata: Metadata = {
    title: "Changer de fiduciaire à Genève | Processus simple et sécurisé",
    description: "Changer de fiduciaire à Genève sans conflit ni rupture d’activité. Audit de reprise, transfert sécurisé et accompagnement complet pour PME.",
};
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col items-center gap-6">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 text-sm text-slate-400">
                            <span className="flex items-center justify-center"><CheckCircle2 className="h-4 w-4 mr-2 text-green-500" /> Sans conflit avec votre ancien fiduciaire</span>
            ...
            <Section className="bg-white py-14">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg text-slate-600 max-w-3xl mx-auto">Changer de fiduciaire n’est pas un échec. C’est une décision stratégique pour sécuriser votre croissance.</p>
                    </div>
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                            ...
                            <p className="text-slate-600 text-sm leading-relaxed">
                                Nous auditons la situation avant toute reprise pour éviter toute rupture ou erreur déclarative.
                            </p>
                        </div>
                        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                            <div className="flex items-center gap-3 mb-3">
                            ...
                            <p className="text-slate-600 text-sm leading-relaxed">
                                Non. Nous coordonnons tout. Vous signez, nous prenons le relais.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <Section className="bg-white">
                <div className="max-w-4xl mx-auto">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-lg text-slate-600 font-medium">Processus structuré en 3 étapes, sans rupture administrative ni fiscale.</p>
                    </div>
                    ...
                    <div className="mt-12 bg-green-50 p-8 rounded-2xl border border-green-100 text-center">
                        <h3 className="text-lg font-bold text-green-900 mb-4">Ce que nous récupérons pour vous</h3>
                        <p className="text-green-800 mb-6">Nous vérifions l’intégralité de votre historique comptable avant toute reprise.</p>
                        <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-8 text-sm text-green-700 font-medium">
                            <span className="flex items-center"><CheckCircle2 className="h-4 w-4 mr-2" /> Vérification des périodes ouvertes</span>
                            <span className="flex items-center"><CheckCircle2 className="h-4 w-4 mr-2" /> Contrôle de cohérence TVA</span>
                            <span className="flex items-center"><CheckCircle2 className="h-4 w-4 mr-2" /> Identification des risques éventuels</span>
                        </div>
                    </div>
                </div>
            </Section>
                ...
                <div className="mx-auto max-w-4xl px-6">
                    ...
                    <div className="flex flex-col items-center gap-8">
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 text-sm text-slate-400">
                            <span className="flex items-center justify-center"><CheckCircle2 className="h-4 w-4 mr-2 text-green-500" /> Consultation gratuite</span>
